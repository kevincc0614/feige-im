...
public class OSSController {
    ...
    @ResponseBody
    public String verifyToken(HttpServletRequest request, @RequestParam("auth_token") String token) throws Exception {
...
//        String exceptSign = Hashing.hmacSha1(configProperties.getTokenSecret().getBytes()).newHasher().putString(uploadPolicy, Charsets.UTF_8).hash().toString();
...
//        }
    ...
    @ResponseBody
    public Response uploadComplete(@RequestBody @Valid UploadCompleteRequest request) {
