package com.ds.feige.im.gateway.configurer;
...
import com.ds.feige.im.gateway.socket.websocket.SimpleHandshakeInterceptor;
import com.ds.feige.im.gateway.socket.websocket.WebSocketDispatcherHandler;
...
public class WebSocketConfiguration implements WebSocketConfigurer {
    ...
    @Autowired
    public WebSocketConfiguration(WebSocketDispatcherHandler webSocketDispatcherHandler,
        SimpleHandshakeInterceptor simpleHandshakeInterceptor, SessionUserService sessionUserService) {
    ...
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        registry.addHandler(webSocketDispatcherHandler, "/ws-endpoint").addInterceptors(simpleHandshakeInterceptor)
            .setAllowedOrigins("*");
    }
