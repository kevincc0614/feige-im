...
public final class IdUtil {
    ...
    private static final long EPOCH_SECOND_OFFSET =
        LocalDate.of(2000, 1, 1).atStartOfDay(ZoneId.of("Z")).toEpochSecond();
    ...
    private static long generateId(long epochSecond, long next, long shardId) {
        return ((epochSecond - EPOCH_SECOND_OFFSET) << 21) | (next << 5) | shardId;
    }
