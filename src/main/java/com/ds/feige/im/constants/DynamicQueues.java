...
public class DynamicQueues {
    ...
    public static final String[] ALL_DYNAMIC_QUEUES=new String[]{
            SERVER_FORWARD_MESSAGE_QUEUE,
            SERVER_FORWARD_DISCONNECT_MESSAGE_QUEUE
    };
    public static final Map<String,String[]> BINDINGS=new HashMap<>();
    static {
        BINDINGS.put(RoutingKeys.GROUP_CREATED, new String[]{QueueNames.GROUP_CREATED_BROADCAST, QueueNames.GROUP_CREATED_CONVERSATION});
